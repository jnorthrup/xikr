 ...
 *
 *
 * The client should not intermix calls to `edu.princeton.cs.algs4.BinaryStdOut` with calls
 ...
 */
object BinaryStdOut {
    private var out: BufferedOutputStream? = null  // output stream (standard output)
    private var buffer: Int = 0                // 8-bit buffer of bits to write
    private var n: Int = 0                     // number of bits remaining in buffer
    private var isInitialized: Boolean = false     // has edu.princeton.cs.algs4.BinaryStdOut been called for first time?

    // initialize edu.princeton.cs.algs4.BinaryStdOut
